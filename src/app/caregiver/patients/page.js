...
export default function CaregiverPatientsPage() {
  ...
  if (selectedPatient) {
    ...
    if (pat) {
      return (
        <AppLayout title={t('allPatients')} requiredRole="caregiver">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                  ...
                  >
                    <td className="py-3.5 px-5">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-primary-dark text-white flex items-center justify-center text-xs font-bold">{pat.avatar}</div>
                        <div>
                ...
                {filtered.length === 0 && (
                  <tr><td colSpan={7} className="py-12 text-center text-text-light">{t('noPatientsMatch')}</td></tr>
                )}
              </tbody>
            </table>
          </div>
